...
Page({
  ...
  onLoad(options) {
    ...
    let [harmony_category_data] = app.globalData.categoryData.filter((item, index) => {
    ...
    wx.cloud.callFunction({
      name: 'getArticleAPI',
      data: {
        _ids: harmony_category_data.content
      },
      success: res => {
        this.setData({
          harmony_category_data,
          harmony_data: res.result
        })
        wx.hideLoading();
      },
      fail: console.error
