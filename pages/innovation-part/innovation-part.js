...
Page({
  ...
  data: {
    innovation_category_data: null,
    innovation_data: null,
    toView: `card_${DEFAULT_PAGE}`,
    imageList: [
      {
        id: 1,
        image_name: "幸得有你，山河无恙，人间结安",
        image_src: "/images/innovation_1.jpg"
      },
      {
        id: 2,
        image_name: "谢谢你们，护我周全",
        image_src: "/images/innovation_2.jpg"
      },
      {
        id: 3,
        image_name: "我们都是平凡人，却有白衣天使为生命逆行",
        image_src: "/images/innovation_3.jpg"
      },
      {
        id: 4,
        image_name: "我们都是平凡人，却有白衣天使为生命逆行",
        image_src: "/images/innovation_4.jpg"
      },
      // {
      //   id: 5,
      //   image_name: "我们都是平凡人，却有白衣天使为生命逆行",
  ...
  onLoad(options) {
    ...
    let [innovation_category_data] = app.globalData.categoryData.filter((item, index) => {
    ...
    wx.cloud.callFunction({
      name: 'getArticleAPI',
      data: {
        _ids: innovation_category_data.content
      },
      success: res => {
        this.setData({
          innovation_category_data,
          innovation_data: res.result
        })
        wx.hideLoading();
      },
      fail: console.error
