...
Page({
    ...
    imageList: [
      {
        ...
        image_src: "/images/love_1.jpg"
      },
      {
        id: 2,
        image_name: "谢谢你们，护我周全",
        image_src: "/images/love_2.jpg"
      },
      {
        id: 3,
        image_name: "我们都是平凡人，却有白衣天使为生命逆行",
        image_src: "/images/love_3.jpg"
      },
      {
        id: 4,
        image_name: "我们都是平凡人，却有白衣天使为生命逆行",
        image_src: "/images/love_4.jpg"
      },
      // {
      //   id: 5,
      //   image_name: "我们都是平凡人，却有白衣天使为生命逆行",
  ...
  onLoad(options) {
    ...
    let [love_category_data] = app.globalData.categoryData.filter((item, index) => {
    ...
    wx.cloud.callFunction({
      name: 'getArticleAPI',
      data: {
        _ids: love_category_data.content
      },
      success: res => {
        this.setData({
          love_category_data,
          love_data: res.result
        })
        wx.hideLoading();
      },
      fail: console.error
